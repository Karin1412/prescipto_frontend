  ...
  return (
    <div className="home-page">
      ...
      <div className="search-by-specialty">
        <div className="title">Tìm theo chuyên ngành</div>
        ...
        <div className="specialty-list">
          <Link
            to="/all-doctors?specialty=general-physician"
            className="specialty"
          >
            <img
              src="/src/assets/General_physician.svg"
          ...
          <Link to="/all-doctors?specialty=gynecologist" className="specialty">
            <img
              src="/src/assets/Gynecologist.svg"
              className="specialty-image"
            />
          ...
          <Link to="/all-doctors?specialty=dermatologist" className="specialty">
            <img
              src="/src/assets/Dermatologist.svg"
              className="specialty-image"
            />
          ...
          <Link to="/all-doctors?specialty=pediatricians" className="specialty">
            <img
              src="/src/assets/Pediatricians.svg"
              className="specialty-image"
            />
          ...
          <Link to="/all-doctors?specialty=neurologist" className="specialty">
            <img
              src="/src/assets/Neurologist.svg"
              className="specialty-image"
            />
            <span className="specialty-name">Bác sĩ thần kinh</span>
          </Link>
          <Link
            to="/all-doctors?specialty=gastroenterologist"
            className="specialty"
          >
            <img
      ...
      <div className="top-doctor">
        ...
        <Link to="/all-doctors">
          <LargeRoundedCornerButton
            className="large-rounded-corner-button py-2 px-6"
            text="Xem thêm"
            variant="secondary"
          />
        </Link>
